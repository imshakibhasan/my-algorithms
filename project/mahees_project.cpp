...
int user=0;
int use=0;
int count4=0,count7=0,count8=0,count6=0;
string name1;
class ticket
{
public:
    string name,adress,nid,mobile,password;
    int i=0,temp[10],opt;
    static int p;
    static int k;
    static int r;
    ...
    void signin()
    {
        ...
        string x,y,sum,f,ff;
        int count=0;
        cout<<" ***Sign In Page--->"<<endl<<endl;
        cout<<"Enter mobile: "<<endl;
        cin>>x;
        cout<<"Enter password: "<<endl;
        cin>>y;
        sum=x+y;
        ifstream inf("ticket.txt");
        ifstream infff("ticket.txt");
        while(inf)
        {
            getline(inf,f);
            count6++;
            if(sum==f)
            {
                ...
                while(infff)
                {
                    ...
                    if(count8==count7-1)
                    {
                        cout<<"**Welcome "<<ff<<"**"<<endl;
                        name1=ff;
                        break;
                    }
                }
                cout<<" *Sign in Complete!!!* "<<endl;
                cout<<"        Choose one->"<<endl<<endl;
                cout<<"             4.Booking Seat."<<endl;
                cout<<"             5.Booking Hotel."<<endl;
                cout<<"             6.Exit From Website."<<endl;
...
//hi :
    ...
    void hotel_booking()
    {
        ...
        int choose;
        cin>>choose;
        cout<<endl<<"How many room you want to BUY??"<<endl;
        cout<<"Room number: ";
        int room;
        cin>>room;
        system("cls");
...
payment:
        ...
        else
        {
            ...
            cout<<" ***"<<endl<<endl;
            cout<<"**** Thank You  "<<name1<<" *****"<<endl<<endl;
            cout<<"        Choose one->"<<endl<<endl;
            cout<<"             4.Booking Seat."<<endl;
            cout<<"             5.Booking Hotel."<<endl;
            cout<<"             6.Exit From Website."<<endl;
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(n==6)
        {
            count4++;
            system("cls");
            cout<<endl<<endl<<endl<<"****Thanks For Visiting Our Website****"<<endl<<endl<<endl;
            exit(0);
        }
        cin>>n;
    }
